<%@ Page Language="VB" AutoEventWireup="false" CodeFile="C++Test.aspx.vb" Inherits="DL_C__Test" %>
...
<head id="Head1" runat="server">
    ...
    <title>C++ EXAMINATION |DISTANC LEARNING</title>
    <%-- ------ CSS ------ --%>
     ...
     <ul class="social-share">
      ...
      <nav class="navbar navbar-inverse" role="banner">
        ...
        <table class="style17">
            ...
            <tr>
                <td>
                    <asp:LinkButton ID="LinkButton4" runat="server">C++TEST 4</asp:LinkButton>
                    &nbsp;</td>
            </tr>
            <tr>
                <td>
