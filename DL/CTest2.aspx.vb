...
Partial Class DL_CTest2
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If (RadioButtonList2.SelectedIndex = 2) Then
            c = c + 2
        End If
        If (RadioButtonList3.SelectedIndex = 2) Then
            c = c + 2
        End If
        If (RadioButtonList4.SelectedIndex = 0) Then
            c = c + 2
        End If
        ...
        ole.CommandText = "UPDATE CTest2 SET [Marks] = '" & c.ToString & "' WHERE [Email] =' " & a & "' ;"
