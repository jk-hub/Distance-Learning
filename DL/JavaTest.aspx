<%@ Page Language="VB" AutoEventWireup="false" CodeFile="JavaTest.aspx.vb" Inherits="DL_JavaTest" %>
...
<head id="Head1" runat="server">
    ...
    <title>JAVA EXAMS|DISTANC LEARNING</title>
    <%-- ------ CSS ------ --%>
     ...
     <ul class="social-share">
      ...
      <nav class="navbar navbar-inverse" role="banner">
        ...
        <table class="style17">
            <tr>
                <td class="style18">
                    <span class="style19">EXAMINATION CENTER : JAVA PROGRAMMING LANGUAGE</span>
                </td>
            </tr>
            <tr>
                <td class="style20">
            ...
            <tr>
                <td>
                    <asp:LinkButton ID="LinkButton1" runat="server">JAVA TEST 1</asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:LinkButton ID="LinkButton2" runat="server">JAVA TEST 2</asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:LinkButton ID="LinkButton3" runat="server">JAVA TEST 3</asp:LinkButton>
&nbsp;&nbsp; //NOT UPLOADED</td>
            </tr>
            <tr>
                <td>
                    <asp:LinkButton ID="LinkButton4" runat="server">JAVA TEST 4</asp:LinkButton>
&nbsp;// Not UPLOADED</td>
            </tr>
            <tr>
                <td>
