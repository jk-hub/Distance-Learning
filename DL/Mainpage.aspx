<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mainpage.aspx.vb" Inherits="Page1_Mainpage" %>
...
<head id="Head1" runat="server">
    ...
    <title>Home | Distance Learning</title>
    <%-- ------ CSS ------ --%>
    ...
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
     ...
     <ul class="social-share">
        ...
        <li><a href="https://www.instagram.com/d.learning" target="_blank"><i class="fa fa-instagram"></i></a></li>
         ...
         <a href="Login.aspx"><font color="red">Sign In</font></a>
    </div>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">"you can live-stream the performance from your computer"</h1>
                                    
                                    <a class="btn-slide animation animated-item-3" href="Signup.aspx">Create An Account</a>
                                </div>
                            </div>
