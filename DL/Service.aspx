<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Service.aspx.vb" Inherits="DL_Service" %>
...
<head id="Head1" runat="server">
    ...
    <title>Services | DISTANCE LEARNING</title>
    <%-- ------ CSS ------ --%>
                ...
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h3>ATTEND Running Lecture Anywhere</h3>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                           <i class="fa fa-book"></i>
                            ...
                            <h3>Put Library in your Pocket</h3>
                        </div>
                    </div><!--/.col-md-4-->
